...
export const PERSONAL_INFO = {
  ...
  journey:
    'My career began in business administration, where I managed digital platforms and realized the power of well-crafted software. In 2022, I decided to turn my interest into a profession by pursuing a Diploma of IT at TAFE. Despite a brief hiatus to embrace the journey of motherhood, I have remained connected to the tech community through volunteer development. Today, as an Australian PR, I am ready to leverage my dual expertise in engineering management and software development to contribute to Australian innovative IT sector.',
};
...
export const ABOUT_FEATURES = [
  {
    label: 'Expertise',
    value:
      'Specialized in building scalable web application with moderm technologies',
  },
  {
    label: 'Clean code',
    value: 'Writing maintainable, well-documented code that scales.',
  },
  {
    label: 'Performance',
    value: 'Optimizing for speed and efficiency in every project.',
  },
];
